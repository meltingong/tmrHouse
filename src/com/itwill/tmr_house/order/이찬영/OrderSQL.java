...
public class OrderSQL {
	...
	public final static String ORDER_SELECT_WITH_PRODUCT_BY_M_ID = "select * from orders o join order_item oi on o.o_no=oi.o_no  join  product p on oi.p_no=p.p_no where o.m_id=? and o.o_no = ?";
}
